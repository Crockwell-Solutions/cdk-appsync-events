 ...
 *
 * This CDK stack sets up the frontend resources for the Airspace Alerter Demo Project.
...
export class FrontendStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: FrontendResourcesProps) {
    ...
    const websiteBucket = new Bucket(this, 'AirspaceAlerterDemoWebsiteBucket', {
      removalPolicy: RemovalPolicy.DESTROY,
      autoDeleteObjects: true,
    });

    // Create CloudFront distribution
    this.distribution = new Distribution(this, 'AirspaceAlerterDemoWebsiteDistribution', {
    ...
    new BucketDeployment(this, 'AirspaceAlerterWebsiteDeployment', {
      sources: [
    ...
    this.exportValue(this.distribution.distributionDomainName, {
      ...
      description: 'The domain name of the CloudFront distribution for the Airspace Alerter Demo',
    });
  }
}
