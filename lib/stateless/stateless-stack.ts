 ...
 *
 * This CDK stack sets up the stateless backend resources for the Airspace Alerter Demo.
...
export class StatelessStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: StatelessStackProps) {
    ...
    this.lambdaResources = new LambdaResources(this, 'AirspaceAlerterLambdaResources', {
      stage: stage,
      envConfig: envConfig,
